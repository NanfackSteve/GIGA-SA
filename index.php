<?php $title_page = 'GIGA S.A'; ?>

<?php ob_start(); ?>

<!-- Carousel Start -->
<div class="container-fluid p-0 pb-2 wow fadeIn" data-wow-delay="0.1s">
    <div class="owl-carousel header-carousel position-relative">

        <div class="owl-carousel-item position-relative" data-dot="<img src='img/carousel-1.jpg'>">
            <img class="img-fluid" src="img/carousel-1.jpg" alt="" style="height: 450px; width: 100%;">
            <div class="owl-carousel-inner">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            <h1 class="display-1 text-white animated slideInDown">Des Solutions Innovantes</h1>
                            <p class="fs-5 fw-medium text-white mb-4 pb-3">Vero elitr justo clita lorem. Ipsum
                                ...
                                rebum sea elitr.</p>
                            <a href="" class="btn btn-primary py-3 px-5 animated slideInLeft">Voir Plus</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="owl-carousel-item position-relative" data-dot="<img src='img/carousel-2.jpg'>">
            <img class="img-fluid" src="img/carousel-2.jpg" alt="" style="height: 450px; width: 100%;">
            <div class="owl-carousel-inner">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            <h1 class="display-1 text-white animated slideInDown">Des Services de Qualité</h1>
                            <p class="fs-5 fw-medium text-white mb-4 pb-3">Vero elitr justo clita lorem. Ipsum
                                dolor at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd
                                rebum sea elitr.</p>
                            <a href="service.php" class="btn btn-primary py-3 px-5 animated slideInLeft">Voir Plus</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="owl-carousel-item position-relative" data-dot="<img src='img/carousel-3.jpg'>">
            <img class="img-fluid" src="img/carousel-3.jpg" alt="" style="height: 450px; width: 100%;">
            <div class="owl-carousel-inner">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            <h1 class="display-1 text-white animated slideInDown">Une Equipe Professionelle</h1>
                            <p class="fs-5 fw-medium text-white mb-4 pb-3">Vero elitr justo clita lorem. Ipsum
                                dolor at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd
                                rebum sea elitr.</p>
                            <a href="team.php" class="btn btn-primary py-3 px-5 animated slideInLeft">Voir Plus</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <a class="btn btn-primary py-3 px-5" href="about.php">Lire Plus</a>
            </div>
        </div>
    </div>
</div>
