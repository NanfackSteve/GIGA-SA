...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>GIGA S.A</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="" name="keywords">
        <meta content="" name="description">

        <!-- Favicon -->
        <link href="img/icons/logo.jpg" rel="icon">
    ...
    <body>
            ...
            <div class="row gx-0 d-none d-lg-flex">
                <div class="col-lg-7 px-5 text-start">
                    <div class="h-100 d-inline-flex align-items-center py-3 me-3">
                        <a class="text-light px-2" href="tel:+237671669004"><i
                                class="fa fa-phone-alt text-light me-2"></i>(+237) 671 669 004</a>
                        <a class="text-light px-2" href="mailto:contact@giga-sa.cm"><i
                                class="fa fa-envelope-open text-light me-2"></i>contact@giga-sa.cm</a>
                    </div>
                </div>
                <div class="col-lg-5 px-5 text-end">
                    <div class="h-100 d-inline-flex align-items-center py-3 me-2">
                        <a class="text-secondary px-2" href="">Terms</a>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn"
            data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0 p-0 d-flex align-items-center ">
                <img class="me-3" src="img/icons/logo-giga-sa.png" height="60" width="60"
                    style="font-family: sans-serif;" alt="Icon">
                <div class="pt-3">
        ...
        <div class="bg-dark" style="margin-bottom: -1px;">
            <marquee behavior=" scroll" direction="left" width="70%" height="35px" class="bg-dark text-light"
                ...
                <b>Bienvenue sur le Site Officiel de GIGA S.A : Libère ton Immagination</b>
            </marquee>
        </div>
        <!-- Slogan End -->
        ...
        <!-- Footer Start -->
        <div class="container-fluid bg-dark text-body footer mt-3 px-0 wow fadeIn" data-wow-delay="0.1s">
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <h3 class="text-light mb-4">Address</h3>
                        <p class="mb-2 text-light"><i class="fa fa-map-marker-alt text-light me-3"></i>Yaounde, Cameroun
                        </p>
                        <p class="mb-2"><a class="text-light " href="tel:+237671669004"><i
                                    class="fa fa-phone-alt text-light me-3"></i>(+237) 671 669 004</a></p>
                        <p class="mb-2"><a class="text-light" href="mailto:contact@giga-sa.cm"><i
                                    class="fa fa-envelope-open text-light me-3"></i>contact@giga-sa.cm</a></p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a href="#">GIGA S.A</a>, All Right Reserved.
                        </div>
