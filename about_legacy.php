...
<div class="container bg-light py-3">
    <div class="row">
        ...
        <div class="col-sm-12 col-lg-10">
            ...
            <div class="text-start mx-auto mb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 650px;">
            ...
            <div class="text-start mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 650px;">
